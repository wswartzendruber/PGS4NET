...
public class PresentationCompositionSegmentWriteTests
{
    ...
    [Fact]
    public async Task Normal_PaletteUpdateID_NoObjects_Async()
    {
        using var stream = new MemoryStream();
        using var writer = new SegmentWriter(stream);
        var pcs = new PresentationCompositionSegment
    ...
    [Fact]
    public async Task Normal_NoPaletteUpdateID_OneObjectForced_Async()
    {
        using var stream = new MemoryStream();
        using var writer = new SegmentWriter(stream);
        var pcs = new PresentationCompositionSegment
    ...
    [Fact]
    public async Task Normal_NoPaletteUpdateID_OneObjectCropped_Async()
    {
        using var stream = new MemoryStream();
        using var writer = new SegmentWriter(stream);
        var pcs = new PresentationCompositionSegment
    ...
    [Fact]
    public async Task Normal_NoPaletteUpdateID_ThreeObjectsMixed_Async()
    {
        using var stream = new MemoryStream();
        using var writer = new SegmentWriter(stream);
        var pcs = new PresentationCompositionSegment
