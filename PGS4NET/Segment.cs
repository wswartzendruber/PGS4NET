...
public abstract class Segment
{
    ...
    protected static void WriteUInt8(Stream stream, byte value)
    {
        stream.WriteByte(value);
    }

    protected static void WriteUInt16BE(Stream stream, ushort value)
    {
        stream.WriteByte((byte)(value >> 8));
        stream.WriteByte((byte)value);
    }

    protected static void WriteUInt24BE(Stream stream, uint value)
    {
    ...
    protected static void WriteUInt32BE(Stream stream, uint value)
    {
